...
const files=['index.html','style.css','parchment.css','storage.css','i18n.js','regions.js','cabin-interior.js','engine.js','item-icons.js','equipment.js','terrain-surface.js','world-art.js','region-art.js','fire-effects.js','cabin-art.js','render.js','audio.js','panels.js','storage-ui.js','game.js'];
